...
return static function (Application $app, MiddlewareFactory $factory, ContainerInterface $container): void {
    ...
    /** CLIENTS */
    $app->route('/client/fetch/{id}', [\Mia\Auth\Handler\AuthHandler::class, App\Handler\Client\FetchHandler::class], ['GET'], 'client.fetch');
    $app->route('/client/list[/{lastname}]', [\Mia\Auth\Handler\AuthHandler::class, App\Handler\Client\ListHandler::class], ['GET'], 'client.list');
    $app->route('/client/remove/{id}', [\Mia\Auth\Handler\AuthHandler::class, App\Handler\Client\RemoveHandler::class], ['DELETE'], 'client.remove');
    $app->route('/client/save', [\Mia\Auth\Handler\AuthHandler::class, new \Mia\Auth\Middleware\MiaRoleAuthMiddleware([MIAUser::ROLE_EDITOR]), App\Handler\Client\SaveHandler::class], ['POST'], 'client.save');
    $app->route('/client/assign-project', [\Mia\Auth\Handler\AuthHandler::class, App\Handler\Client\AssignProjectHandler::class], ['PATCH'], 'client.assign-project');
    $app->route('/client/dashboard', [\Mia\Auth\Handler\AuthHandler::class, App\Handler\Client\DashboardHandler::class], ['GET'], 'client.dashboard');
    // $app->get('/client', App\Handler\ClientHandler::class, 'client');
